...
export const showCustomToast = ({ message, image, navigate }) => {
    ...
    currentToastId = toast.custom((t) => (
        <div className={`${t.visible ? 'animate-enter' : 'animate-leave'} max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-gray-400 ring-opacity-5`} >
